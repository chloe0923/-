...
external_ball_mass = 2.8e+6/moon_external_ball_num  #會被拉開，dt=86400，正常地月半徑
# external_ball_mass = 9.3e10/moon_external_ball_num
external_ball_radius = 200000   #小球本身的半徑, 為顯示效果  m
# ball_center_dis = 10000000     #初始小球和繞行天體中心的最大距離 m
ball_center_dis = 6.5            #真實距離
...
"""
spring_force_dis_threshold = 6   # m
while True:
    if not is_started:
        continue
