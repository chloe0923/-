...
"""
 2. 畫面設定
"""
scene = canvas(title="Vertical Circle", width=1200, height=600, x=0, y=0, background=color.black)
...
while theta<360:
    ...
    while phi<360:
        ...
        #     R*math.cos(theta))
        pos = vec(
            R*math.sin(theta/180*math.pi)*math.cos(phi/180*math.pi), 
            R*math.sin(theta/180*math.pi)*math.sin(phi/180*math.pi), 
            R*math.cos(theta/180*math.pi))
        pos+=external_pos
        ball = sphere(
            pos=pos, 
